		...
		return (
			<div ref='container'
				...
				<div className="thread">
					{activeChat.friendRequest == 'receiver' ? <Request user={user} requestAccepted={this.requestAccepted} handler={this.props.handler} activeChat={activeChat} socket={socket} sender={false} /> : ''}
